...
int main(){
	...
	//spherical photon
	Kerr_potential_test_photon photon(M, a,1.0/3.0,1.00, 100);
	
	photon.set_initial_data(0.0,2.5,M_PI_2, M_PI_4);
    ...
    std::cout<< "The average deviation from expected zero is: "<< photon.energy_checker/photon.size <<"\n";
	std::cout<< "The starting value of the Carter Constant was: "<< photon.Q <<"\n";
	std::cout<< "The numerical value of the average Carter Constant was: "<< photon.carter_constant/photon.size <<"\n";
	std::cout<< "The deviation in the Carter Constant was: "<< fabs(photon.Q - photon.carter_constant/photon.size) <<"\n";
