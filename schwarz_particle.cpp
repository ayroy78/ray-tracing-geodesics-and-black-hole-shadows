...
public:
    ...
    void save_data() {
		std::ofstream myFile("particle_schwarz_elliptical.txt");
...
int main() {
	...
	//Do the RK4
	particle.RK4(pow(10,-2), pow(10,-13), pow(10,-4), pow(10,-1));
    std::cout << "The size of the iteration was: "<< particle.x.size()<<"\n";
    std::cout << "The average deviation from zero was: "<< particle.energy_checker/particle.x.size() <<"\n";
